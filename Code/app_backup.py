...
def create_player_div(i, team_unique_ids, team_names, team_picks, data, team_codes, fixture_data, season_latest, round_curr, font_size, round_id):
    ...
    match_1 = html.Div([
        ...
        html.Div(children=player_opposition[0], id='player_'+str(round_id)+'_'+str(player_no)+'_1_against', style={'width': '7%', 'display': 'inline-block', 'float': 'left', 'font-size': font_size, 'text-align': 'center'}),
...
def update_player_data_gw2(player_2_1_unique_id,
                            player_2_2_unique_id,
                            player_2_3_unique_id,
                            player_2_4_unique_id,
                            player_2_5_unique_id,
                            player_2_6_unique_id,
                            player_2_7_unique_id,
                            player_2_8_unique_id,
                            player_2_9_unique_id,
                            player_2_10_unique_id,
                            player_2_11_unique_id,
                            player_2_12_unique_id,
                            player_2_13_unique_id,
                            player_2_14_unique_id,
                            player_2_15_unique_id,
                            team_names_json_2,
                            team_unique_ids_json_2,
                            team_names_json_3,
                            team_unique_ids_json_3):
    ...
    team_unique_ids_3 = pd.read_json(team_unique_ids_json_3, orient='split', typ='series')
    team_names_3 = pd.read_json(team_names_json_3, orient='split', typ='series')
    ...
    #GW + 1
    player_2_1_id = determine_element_id(data, player_2_1_unique_id, 2020)
    (player_2_1_unique_id, player_2_1_player_form, player_2_1_team_unique_id, player_2_1_team_id, player_2_1_position, player_2_1_team_code, player_2_1_player_name, player_2_1_opposition, player_2_1_was_home, player_2_1_odds_win, n_matches) = \
            planner_process_player(data, team_codes, fixture_data, player_2_1_id, season_latest, gw_next)

    if int(player_2_1_unique_id) in team_unique_ids_2.values:
        player_2_1_value = '{0:.1f}'.format(team_picks[team_picks['element']==player_2_1_id]['selling_price'].values[0]/10)
    else:
        round_player_max = data_2020[(data_2020['unique_id']==player_2_1_unique_id)]['round'].max()
        player_2_1_value = '{0:.1f}'.format(data_2020[(data_2020['unique_id']==player_2_1_unique_id) & (data_2020['round']==round_player_max)]['value'].values[0]/10)

    # Player 2
    player_2_2_id = determine_element_id(data, player_2_2_unique_id, 2020)
    (player_2_2_unique_id, player_2_2_player_form, player_2_2_team_unique_id, player_2_2_team_id, player_2_2_position, player_2_2_team_code, player_2_2_player_name, player_2_2_opposition, player_2_2_was_home, player_2_2_odds_win, n_matches) = \
            planner_process_player(data, team_codes, fixture_data, player_2_2_id, season_latest, gw_next)

    if int(player_2_2_unique_id) in team_unique_ids_2.values:
        player_2_2_value = '{0:.1f}'.format(team_picks[team_picks['element']==player_2_2_id]['selling_price'].values[0]/10)
    else:
        round_player_max = data_2020[(data_2020['unique_id']==player_2_2_unique_id)]['round'].max()
        player_2_2_value = '{0:.1f}'.format(data_2020[(data_2020['unique_id']==player_2_2_unique_id) & (data_2020['round']==round_player_max)]['value'].values[0]/10)

    # Player 3
    player_2_3_id = determine_element_id(data, player_2_3_unique_id, 2020)
    (player_2_3_unique_id, player_2_3_player_form, player_2_3_team_unique_id, player_2_3_team_id, player_2_3_position, player_2_3_team_code, player_2_3_player_name, player_2_3_opposition, player_2_3_was_home, player_2_3_odds_win, n_matches) = \
            planner_process_player(data, team_codes, fixture_data, player_2_3_id, season_latest, gw_next)

    if int(player_2_3_unique_id) in team_unique_ids_2.values:
        player_2_3_value = '{0:.1f}'.format(team_picks[team_picks['element']==player_2_3_id]['selling_price'].values[0]/10)
    else:
        round_player_max = data_2020[(data_2020['unique_id']==player_2_3_unique_id)]['round'].max()
        player_2_3_value = '{0:.1f}'.format(data_2020[(data_2020['unique_id']==player_2_3_unique_id) & (data_2020['round']==round_player_max)]['value'].values[0]/10)

    # Player 4
    player_2_4_id = determine_element_id(data, player_2_4_unique_id, 2020)
    (player_2_4_unique_id, player_2_4_player_form, player_2_4_team_unique_id, player_2_4_team_id, player_2_4_position, player_2_4_team_code, player_2_4_player_name, player_2_4_opposition, player_2_4_was_home, player_2_4_odds_win, n_matches) = \
            planner_process_player(data, team_codes, fixture_data, player_2_4_id, season_latest, gw_next)

    if int(player_2_4_unique_id) in team_unique_ids_2.values:
        player_2_4_value = '{0:.1f}'.format(team_picks[team_picks['element']==player_2_4_id]['selling_price'].values[0]/10)
    else:
        round_player_max = data_2020[(data_2020['unique_id']==player_2_4_unique_id)]['round'].max()
        player_2_4_value = '{0:.1f}'.format(data_2020[(data_2020['unique_id']==player_2_4_unique_id) & (data_2020['round']==round_player_max)]['value'].values[0]/10)

    # Player 5
    player_2_5_id = determine_element_id(data, player_2_5_unique_id, 2020)
    (player_2_5_unique_id, player_2_5_player_form, player_2_5_team_unique_id, player_2_5_team_id, player_2_5_position, player_2_5_team_code, player_2_5_player_name, player_2_5_opposition, player_2_5_was_home, player_2_5_odds_win, n_matches) = \
            planner_process_player(data, team_codes, fixture_data, player_2_5_id, season_latest, gw_next)

    if int(player_2_5_unique_id) in team_unique_ids_2.values:
        player_2_5_value = '{0:.1f}'.format(team_picks[team_picks['element']==player_2_5_id]['selling_price'].values[0]/10)
    else:
        round_player_max = data_2020[(data_2020['unique_id']==player_2_5_unique_id)]['round'].max()
        player_2_5_value = '{0:.1f}'.format(data_2020[(data_2020['unique_id']==player_2_5_unique_id) & (data_2020['round']==round_player_max)]['value'].values[0]/10)

    # Player 6
    player_2_6_id = determine_element_id(data, player_2_6_unique_id, 2020)
    (player_2_6_unique_id, player_2_6_player_form, player_2_6_team_unique_id, player_2_6_team_id, player_2_6_position, player_2_6_team_code, player_2_6_player_name, player_2_6_opposition, player_2_6_was_home, player_2_6_odds_win, n_matches) = \
            planner_process_player(data, team_codes, fixture_data, player_2_6_id, season_latest, gw_next)

    if int(player_2_6_unique_id) in team_unique_ids_2.values:
        player_2_6_value = '{0:.1f}'.format(team_picks[team_picks['element']==player_2_6_id]['selling_price'].values[0]/10)
    else:
        round_player_max = data_2020[(data_2020['unique_id']==player_2_6_unique_id)]['round'].max()
        player_2_6_value = '{0:.1f}'.format(data_2020[(data_2020['unique_id']==player_2_6_unique_id) & (data_2020['round']==round_player_max)]['value'].values[0]/10)

    # Player 7
    player_2_7_id = determine_element_id(data, player_2_7_unique_id, 2020)
    (player_2_7_unique_id, player_2_7_player_form, player_2_7_team_unique_id, player_2_7_team_id, player_2_7_position, player_2_7_team_code, player_2_7_player_name, player_2_7_opposition, player_2_7_was_home, player_2_7_odds_win, n_matches) = \
            planner_process_player(data, team_codes, fixture_data, player_2_7_id, season_latest, gw_next)

    if int(player_2_7_unique_id) in team_unique_ids_2.values:
        player_2_7_value = '{0:.1f}'.format(team_picks[team_picks['element']==player_2_7_id]['selling_price'].values[0]/10)
    else:
        round_player_max = data_2020[(data_2020['unique_id']==player_2_7_unique_id)]['round'].max()
        player_2_7_value = '{0:.1f}'.format(data_2020[(data_2020['unique_id']==player_2_7_unique_id) & (data_2020['round']==round_player_max)]['value'].values[0]/10)

    # Player 8
    player_2_8_id = determine_element_id(data, player_2_8_unique_id, 2020)
    (player_2_8_unique_id, player_2_8_player_form, player_2_8_team_unique_id, player_2_8_team_id, player_2_8_position, player_2_8_team_code, player_2_8_player_name, player_2_8_opposition, player_2_8_was_home, player_2_8_odds_win, n_matches) = \
            planner_process_player(data, team_codes, fixture_data, player_2_8_id, season_latest, gw_next)

    if int(player_2_8_unique_id) in team_unique_ids_2.values:
        player_2_8_value = '{0:.1f}'.format(team_picks[team_picks['element']==player_2_8_id]['selling_price'].values[0]/10)
    else:
        round_player_max = data_2020[(data_2020['unique_id']==player_2_8_unique_id)]['round'].max()
        player_2_8_value = '{0:.1f}'.format(data_2020[(data_2020['unique_id']==player_2_8_unique_id) & (data_2020['round']==round_player_max)]['value'].values[0]/10)

    # Player 9
    player_2_9_id = determine_element_id(data, player_2_9_unique_id, 2020)
    (player_2_9_unique_id, player_2_9_player_form, player_2_9_team_unique_id, player_2_9_team_id, player_2_9_position, player_2_9_team_code, player_2_9_player_name, player_2_9_opposition, player_2_9_was_home, player_2_9_odds_win, n_matches) = \
            planner_process_player(data, team_codes, fixture_data, player_2_9_id, season_latest, gw_next)

    if int(player_2_9_unique_id) in team_unique_ids_2.values:
        player_2_9_value = '{0:.1f}'.format(team_picks[team_picks['element']==player_2_9_id]['selling_price'].values[0]/10)
    else:
        round_player_max = data_2020[(data_2020['unique_id']==player_2_9_unique_id)]['round'].max()
        player_2_9_value = '{0:.1f}'.format(data_2020[(data_2020['unique_id']==player_2_9_unique_id) & (data_2020['round']==round_player_max)]['value'].values[0]/10)

    # Player 10
    player_2_10_id = determine_element_id(data, player_2_10_unique_id, 2020)
    (player_2_10_unique_id, player_2_10_player_form, player_2_10_team_unique_id, player_2_10_team_id, player_2_10_position, player_2_10_team_code, player_2_10_player_name, player_2_10_opposition, player_2_10_was_home, player_2_10_odds_win, n_matches) = \
            planner_process_player(data, team_codes, fixture_data, player_2_10_id, season_latest, gw_next)

    if int(player_2_10_unique_id) in team_unique_ids_2.values:
        player_2_10_value = '{0:.1f}'.format(team_picks[team_picks['element']==player_2_10_id]['selling_price'].values[0]/10)
    else:
        round_player_max = data_2020[(data_2020['unique_id']==player_2_10_unique_id)]['round'].max()
        player_2_10_value = '{0:.1f}'.format(data_2020[(data_2020['unique_id']==player_2_10_unique_id) & (data_2020['round']==round_player_max)]['value'].values[0]/10)

    # Player 11
    player_2_11_id = determine_element_id(data, player_2_11_unique_id, 2020)
    (player_2_11_unique_id, player_2_11_player_form, player_2_11_team_unique_id, player_2_11_team_id, player_2_11_position, player_2_11_team_code, player_2_11_player_name, player_2_11_opposition, player_2_11_was_home, player_2_11_odds_win, n_matches) = \
            planner_process_player(data, team_codes, fixture_data, player_2_11_id, season_latest, gw_next)

    if int(player_2_11_unique_id) in team_unique_ids_2.values:
        player_2_11_value = '{0:.1f}'.format(team_picks[team_picks['element']==player_2_11_id]['selling_price'].values[0]/10)
    else:
        round_player_max = data_2020[(data_2020['unique_id']==player_2_11_unique_id)]['round'].max()
        player_2_11_value = '{0:.1f}'.format(data_2020[(data_2020['unique_id']==player_2_11_unique_id) & (data_2020['round']==round_player_max)]['value'].values[0]/10)

    # Player 12
    player_2_12_id = determine_element_id(data, player_2_12_unique_id, 2020)
    (player_2_12_unique_id, player_2_12_player_form, player_2_12_team_unique_id, player_2_12_team_id, player_2_12_position, player_2_12_team_code, player_2_12_player_name, player_2_12_opposition, player_2_12_was_home, player_2_12_odds_win, n_matches) = \
            planner_process_player(data, team_codes, fixture_data, player_2_12_id, season_latest, gw_next)

    if int(player_2_12_unique_id) in team_unique_ids_2.values:
        player_2_12_value = '{0:.1f}'.format(team_picks[team_picks['element']==player_2_12_id]['selling_price'].values[0]/10)
    else:
        round_player_max = data_2020[(data_2020['unique_id']==player_2_12_unique_id)]['round'].max()
        player_2_12_value = '{0:.1f}'.format(data_2020[(data_2020['unique_id']==player_2_12_unique_id) & (data_2020['round']==round_player_max)]['value'].values[0]/10)

    # Player 13
    player_2_13_id = determine_element_id(data, player_2_13_unique_id, 2020)
    (player_2_13_unique_id, player_2_13_player_form, player_2_13_team_unique_id, player_2_13_team_id, player_2_13_position, player_2_13_team_code, player_2_13_player_name, player_2_13_opposition, player_2_13_was_home, player_2_13_odds_win, n_matches) = \
            planner_process_player(data, team_codes, fixture_data, player_2_13_id, season_latest, gw_next)

    if int(player_2_13_unique_id) in team_unique_ids_2.values:
        player_2_13_value = '{0:.1f}'.format(team_picks[team_picks['element']==player_2_13_id]['selling_price'].values[0]/10)
    else:
        round_player_max = data_2020[(data_2020['unique_id']==player_2_13_unique_id)]['round'].max()
        player_2_13_value = '{0:.1f}'.format(data_2020[(data_2020['unique_id']==player_2_13_unique_id) & (data_2020['round']==round_player_max)]['value'].values[0]/10)

    # Player 14
    player_2_14_id = determine_element_id(data, player_2_14_unique_id, 2020)
    (player_2_14_unique_id, player_2_14_player_form, player_2_14_team_unique_id, player_2_14_team_id, player_2_14_position, player_2_14_team_code, player_2_14_player_name, player_2_14_opposition, player_2_14_was_home, player_2_14_odds_win, n_matches) = \
            planner_process_player(data, team_codes, fixture_data, player_2_14_id, season_latest, gw_next)

    if int(player_2_14_unique_id) in team_unique_ids_2.values:
        player_2_14_value = '{0:.1f}'.format(team_picks[team_picks['element']==player_2_14_id]['selling_price'].values[0]/10)
    else:
        round_player_max = data_2020[(data_2020['unique_id']==player_2_14_unique_id)]['round'].max()
        player_2_14_value = '{0:.1f}'.format(data_2020[(data_2020['unique_id']==player_2_14_unique_id) & (data_2020['round']==round_player_max)]['value'].values[0]/10)

    # Player 15
    player_2_15_id = determine_element_id(data, player_2_15_unique_id, 2020)
    (player_2_15_unique_id, player_2_15_player_form, player_2_15_team_unique_id, player_2_15_team_id, player_2_15_position, player_2_15_team_code, player_2_15_player_name, player_2_15_opposition, player_2_15_was_home, player_2_15_odds_win, n_matches) = \
            planner_process_player(data, team_codes, fixture_data, player_2_15_id, season_latest, gw_next)

    if int(player_2_15_unique_id) in team_unique_ids_2.values:
        player_2_15_value = '{0:.1f}'.format(team_picks[team_picks['element']==player_2_15_id]['selling_price'].values[0]/10)
    else:
        round_player_max = data_2020[(data_2020['unique_id']==player_2_15_unique_id)]['round'].max()
        player_2_15_value = '{0:.1f}'.format(data_2020[(data_2020['unique_id']==player_2_15_unique_id) & (data_2020['round']==round_player_max)]['value'].values[0]/10)
    ...
    #Player 1
    player_3_1_value = player_2_1_unique_id
    if player_3_1_value not in team_unique_ids_2.unique():
        team_names_3.iloc[0] = player_2_1_player_name
        team_unique_ids_2.iloc[0] = player_2_1_unique_id

    player_3_1_option = [{'label': name, 'value': team_unique_ids_2[i]} for i, name in enumerate(team_names_2)]

    #Player 2
    player_3_2_value = player_2_2_unique_id
    if player_3_2_value not in team_unique_ids_2.unique():
        team_names_2.iloc[0] = player_2_2_player_name
        team_unique_ids_2.iloc[0] = player_2_2_unique_id

    player_3_2_option = [{'label': name, 'value': team_unique_ids_2[i]} for i, name in enumerate(team_names_2)]

    #Player 3
    player_3_3_value = player_2_3_unique_id
    if player_3_3_value not in team_unique_ids_2.unique():
        team_names_2.iloc[0] = player_2_3_player_name
        team_unique_ids_2.iloc[0] = player_2_3_unique_id

    player_3_3_option = [{'label': name, 'value': team_unique_ids_2[i]} for i, name in enumerate(team_names_2)]

    #Player 4
    player_3_4_value = player_2_4_unique_id
    if player_3_4_value not in team_unique_ids_2.unique():
        team_names_2.iloc[0] = player_2_4_player_name
        team_unique_ids_2.iloc[0] = player_2_4_unique_id

    player_3_4_option = [{'label': name, 'value': team_unique_ids_2[i]} for i, name in enumerate(team_names_2)]

    #Player 5
    player_3_5_value = player_2_1_unique_id
    if player_3_5_value not in team_unique_ids_2.unique():
        team_names_2.iloc[0] = player_2_5_player_name
        team_unique_ids_2.iloc[0] = player_2_5_unique_id

    player_3_5_option = [{'label': name, 'value': team_unique_ids_2[i]} for i, name in enumerate(team_names_2)]

    #Player 6
    player_3_6_value = player_2_6_unique_id
    if player_3_6_value not in team_unique_ids_2.unique():
        team_names_2.iloc[0] = player_2_6_player_name
        team_unique_ids_2.iloc[0] = player_2_6_unique_id

    player_3_6_option = [{'label': name, 'value': team_unique_ids_2[i]} for i, name in enumerate(team_names_2)]

    #Player 7
    player_3_7_value = player_2_7_unique_id
    if player_3_1_value not in team_unique_ids_2.unique():
        team_names_2.iloc[0] = player_2_7_player_name
        team_unique_ids_2.iloc[0] = player_2_7_unique_id

    player_3_7_option = [{'label': name, 'value': team_unique_ids_2[i]} for i, name in enumerate(team_names_2)]

    #Player 8
    player_3_8_value = player_2_8_unique_id
    if player_3_8_value not in team_unique_ids_2.unique():
        team_names_2.iloc[0] = player_2_8_player_name
        team_unique_ids_2.iloc[0] = player_2_8_unique_id

    player_3_8_option = [{'label': name, 'value': team_unique_ids_2[i]} for i, name in enumerate(team_names_2)]

    #Player 9
    player_3_9_value = player_2_9_unique_id
    if player_3_9_value not in team_unique_ids_2.unique():
        team_names_2.iloc[0] = player_2_9_player_name
        team_unique_ids_2.iloc[0] = player_2_9_unique_id

    player_3_9_option = [{'label': name, 'value': team_unique_ids_2[i]} for i, name in enumerate(team_names_2)]

    #Player 10
    player_3_10_value = player_2_10_unique_id
    if player_3_10_value not in team_unique_ids_2.unique():
        team_names_2.iloc[0] = player_2_10_player_name
        team_unique_ids_2.iloc[0] = player_2_10_unique_id

    player_3_10_option = [{'label': name, 'value': team_unique_ids_2[i]} for i, name in enumerate(team_names_2)]

    #Player 11
    player_3_11_value = player_2_11_unique_id
    if player_3_11_value not in team_unique_ids_2.unique():
        team_names_2.iloc[0] = player_2_11_player_name
        team_unique_ids_2.iloc[0] = player_2_11_unique_id

    player_3_11_option = [{'label': name, 'value': team_unique_ids_2[i]} for i, name in enumerate(team_names_2)]

    #Player 12
    player_3_12_value = player_2_12_unique_id
    if player_3_12_value not in team_unique_ids_2.unique():
        team_names_2.iloc[0] = player_2_12_player_name
        team_unique_ids_2.iloc[0] = player_2_12_unique_id

    player_3_12_option = [{'label': name, 'value': team_unique_ids_2[i]} for i, name in enumerate(team_names_2)]

    #Player 13
    player_3_13_value = player_2_13_unique_id
    if player_3_13_value not in team_unique_ids_2.unique():
        team_names_2.iloc[0] = player_2_13_player_name
        team_unique_ids_2.iloc[0] = player_2_13_unique_id

    player_3_13_option = [{'label': name, 'value': team_unique_ids_2[i]} for i, name in enumerate(team_names_2)]

    #Player 14
    player_3_14_value = player_2_14_unique_id
    if player_3_1_value not in team_unique_ids_2.unique():
        team_names_2.iloc[0] = player_2_14_player_name
        team_unique_ids_2.iloc[0] = player_2_14_unique_id

    player_3_14_option = [{'label': name, 'value': team_unique_ids_2[i]} for i, name in enumerate(team_names_2)]

    #Player 15
    player_3_15_value = player_2_15_unique_id
    if player_3_1_value not in team_unique_ids_2.unique():
        team_names_2.iloc[0] = player_2_15_player_name
        team_unique_ids_2.iloc[0] = player_2_15_unique_id

    player_3_15_option = [{'label': name, 'value': team_unique_ids_2[i]} for i, name in enumerate(team_names_2)]

    team_names_json_2 = team_names_2.to_json(date_format='iso', orient='split')
    team_unique_ids_json_2 = team_unique_ids_2.to_json(date_format='iso', orient='split')


    return (player_2_1_value, player_2_1_position, player_2_1_team_code, player_2_1_opposition[0], player_2_1_was_home[0], player_2_1_odds_win[0], player_2_1_player_form[0], player_2_1_opposition[1], player_2_1_was_home[1], player_2_1_odds_win[1], player_2_1_player_form[1],
            player_2_2_value, player_2_2_position, player_2_2_team_code, player_2_2_opposition[0], player_2_2_was_home[0], player_2_2_odds_win[0], player_2_2_player_form[0], player_2_2_opposition[1], player_2_2_was_home[1], player_2_2_odds_win[1], player_2_2_player_form[1],
            player_2_3_value, player_2_3_position, player_2_3_team_code, player_2_3_opposition[0], player_2_3_was_home[0], player_2_3_odds_win[0], player_2_3_player_form[0], player_2_3_opposition[1], player_2_3_was_home[1], player_2_3_odds_win[1], player_2_3_player_form[1],
            player_2_4_value, player_2_4_position, player_2_4_team_code, player_2_4_opposition[0], player_2_4_was_home[0], player_2_4_odds_win[0], player_2_4_player_form[0], player_2_4_opposition[1], player_2_4_was_home[1], player_2_4_odds_win[1], player_2_4_player_form[1],
            player_2_5_value, player_2_5_position, player_2_5_team_code, player_2_5_opposition[0], player_2_5_was_home[0], player_2_5_odds_win[0], player_2_5_player_form[0], player_2_5_opposition[1], player_2_5_was_home[1], player_2_5_odds_win[1], player_2_5_player_form[1],
            player_2_6_value, player_2_6_position, player_2_6_team_code, player_2_6_opposition[0], player_2_6_was_home[0], player_2_6_odds_win[0], player_2_6_player_form[0], player_2_6_opposition[1], player_2_6_was_home[1], player_2_6_odds_win[1], player_2_6_player_form[1],
            player_2_7_value, player_2_7_position, player_2_7_team_code, player_2_7_opposition[0], player_2_7_was_home[0], player_2_7_odds_win[0], player_2_7_player_form[0], player_2_7_opposition[1], player_2_7_was_home[1], player_2_7_odds_win[1], player_2_7_player_form[1],
            player_2_8_value, player_2_8_position, player_2_8_team_code, player_2_8_opposition[0], player_2_8_was_home[0], player_2_8_odds_win[0], player_2_8_player_form[0], player_2_8_opposition[1], player_2_8_was_home[1], player_2_8_odds_win[1], player_2_8_player_form[1],
            player_2_9_value, player_2_9_position, player_2_9_team_code, player_2_9_opposition[0], player_2_9_was_home[0], player_2_9_odds_win[0], player_2_9_player_form[0], player_2_9_opposition[1], player_2_9_was_home[1], player_2_9_odds_win[1], player_2_9_player_form[1],
            player_2_10_value, player_2_10_position, player_2_10_team_code, player_2_10_opposition[0], player_2_10_was_home[0], player_2_10_odds_win[0], player_2_10_player_form[0], player_2_10_opposition[1], player_2_10_was_home[1], player_2_10_odds_win[1], player_2_10_player_form[1],
            player_2_11_value, player_2_11_position, player_2_11_team_code, player_2_11_opposition[0], player_2_11_was_home[0], player_2_11_odds_win[0], player_2_11_player_form[0], player_2_11_opposition[1], player_2_11_was_home[1], player_2_11_odds_win[1], player_2_11_player_form[1],
            player_2_12_value, player_2_12_position, player_2_12_team_code, player_2_12_opposition[0], player_2_12_was_home[0], player_2_12_odds_win[0], player_2_12_player_form[0], player_2_12_opposition[1], player_2_12_was_home[1], player_2_12_odds_win[1], player_2_12_player_form[1],
            player_2_13_value, player_2_13_position, player_2_13_team_code, player_2_13_opposition[0], player_2_13_was_home[0], player_2_13_odds_win[0], player_2_13_player_form[0], player_2_13_opposition[1], player_2_13_was_home[1], player_2_13_odds_win[1], player_2_13_player_form[1],
            player_2_14_value, player_2_14_position, player_2_14_team_code, player_2_14_opposition[0], player_2_14_was_home[0], player_2_14_odds_win[0], player_2_14_player_form[0], player_2_14_opposition[1], player_2_14_was_home[1], player_2_14_odds_win[1], player_2_14_player_form[1],
            player_2_15_value, player_2_15_position, player_2_15_team_code, player_2_15_opposition[0], player_2_15_was_home[0], player_2_15_odds_win[0], player_2_15_player_form[0], player_2_15_opposition[1], player_2_15_was_home[1], player_2_15_odds_win[1], player_2_15_player_form[1],
            player_3_1_option, player_3_1_value,
            player_3_2_option, player_3_2_value,
            player_3_3_option, player_3_3_value,
            player_3_4_option, player_3_4_value,
            player_3_5_option, player_3_5_value,
            player_3_6_option, player_3_6_value,
            player_3_7_option, player_3_7_value,
            player_3_8_option, player_3_8_value,
            player_3_9_option, player_3_9_value,
            player_3_10_option, player_3_10_value,
            player_3_11_option, player_3_11_value,
            player_3_12_option, player_3_12_value,
            player_3_13_option, player_3_13_value,
            player_3_14_option, player_3_14_value,
            player_3_15_option, player_3_15_value,
            team_names_json_2, team_unique_ids_json_2, team_names_json_2, team_unique_ids_json_2)
...
def select_transfers_gw1(player_1_1_transfer_tick,
                         player_1_2_transfer_tick,
                         player_1_3_transfer_tick,
                         player_1_4_transfer_tick,
                         player_1_5_transfer_tick,
                         player_1_6_transfer_tick,
                         player_1_7_transfer_tick,
                         player_1_8_transfer_tick,
                         player_1_9_transfer_tick,
                         player_1_10_transfer_tick,
                         player_1_11_transfer_tick,
                         player_1_s1_transfer_tick,
                         player_1_s2_transfer_tick,
                         player_1_s3_transfer_tick,
                         player_1_s4_transfer_tick,
                         player_2_1_transfer_tick,
                         player_2_2_transfer_tick,
                         player_2_3_transfer_tick,
                         player_2_4_transfer_tick,
                         player_2_5_transfer_tick,
                         player_2_6_transfer_tick,
                         player_2_7_transfer_tick,
                         player_2_8_transfer_tick,
                         player_2_9_transfer_tick,
                         player_2_10_transfer_tick,
                         player_2_11_transfer_tick,
                         player_2_s1_transfer_tick,
                         player_2_s2_transfer_tick,
                         player_2_s3_transfer_tick,
                         player_2_s4_transfer_tick,
                         player_3_1_transfer_tick,
                         player_3_2_transfer_tick,
                         player_3_3_transfer_tick,
                         player_3_4_transfer_tick,
                         player_3_5_transfer_tick,
                         player_3_6_transfer_tick,
                         player_3_7_transfer_tick,
                         player_3_8_transfer_tick,
                         player_3_9_transfer_tick,
                         player_3_10_transfer_tick,
                         player_3_11_transfer_tick,
                         player_3_s1_transfer_tick,
                         player_3_s2_transfer_tick,
                         player_3_s3_transfer_tick,
                         player_3_s4_transfer_tick,
                         player_4_1_transfer_tick,
                         player_4_2_transfer_tick,
                         player_4_3_transfer_tick,
                         player_4_4_transfer_tick,
                         player_4_5_transfer_tick,
                         player_4_6_transfer_tick,
                         player_4_7_transfer_tick,
                         player_4_8_transfer_tick,
                         player_4_9_transfer_tick,
                         player_4_10_transfer_tick,
                         player_4_11_transfer_tick,
                         player_4_s1_transfer_tick,
                         player_4_s2_transfer_tick,
                         player_4_s3_transfer_tick,
                         player_4_s4_transfer_tick,
                         team_names_json_1,
                         team_unique_ids_json_1,
                         team_names_json_2,
                         team_unique_ids_json_2,
    ...
    if player_1_1_transfer_tick != None:
        if len(player_1_1_transfer_tick) > 0:
            player_1_1_options = [[{'label': name, 'value': players_2020_unique_ids[i]} for i, name in enumerate(players_2020_names)]]
        else:
            player_1_1_options = [[{'label': name, 'value': team_unique_ids_1[i]} for i, name in enumerate(team_names_1)]]

    else:
        player_1_1_options = [[{'label': name, 'value': team_unique_ids_1[i]} for i, name in enumerate(team_names_1)]]

    if player_1_2_transfer_tick != None:
        if len(player_1_2_transfer_tick) > 0:
            player_1_2_options = [[{'label': name, 'value': players_2020_unique_ids[i]} for i, name in enumerate(players_2020_names)]]
        else:
            player_1_2_options = [[{'label': name, 'value': team_unique_ids_1[i]} for i, name in enumerate(team_names_1)]]
    else:
        player_1_2_options = [[{'label': name, 'value': team_unique_ids_1[i]} for i, name in enumerate(team_names_1)]]

    if player_1_3_transfer_tick != None:
        if len(player_1_3_transfer_tick) > 0:
            player_1_3_options = [[{'label': name, 'value': players_2020_unique_ids[i]} for i, name in enumerate(players_2020_names)]]
        else:
            player_1_3_options = [[{'label': name, 'value': team_unique_ids_1[i]} for i, name in enumerate(team_names_1)]]
    else:
        player_1_3_options = [[{'label': name, 'value': team_unique_ids_1[i]} for i, name in enumerate(team_names_1)]]

    if player_1_4_transfer_tick != None:
        if len(player_1_4_transfer_tick) > 0:
            player_1_4_options = [[{'label': name, 'value': players_2020_unique_ids[i]} for i, name in enumerate(players_2020_names)]]
        else:
            player_1_4_options = [[{'label': name, 'value': team_unique_ids_1[i]} for i, name in enumerate(team_names_1)]]
    else:
        player_1_4_options = [[{'label': name, 'value': team_unique_ids_1[i]} for i, name in enumerate(team_names_1)]]

    if player_1_5_transfer_tick != None:
        if len(player_1_5_transfer_tick) > 0:
            player_1_5_options = [[{'label': name, 'value': players_2020_unique_ids[i]} for i, name in enumerate(players_2020_names)]]
        else:
            player_1_5_options = [[{'label': name, 'value': team_unique_ids_1[i]} for i, name in enumerate(team_names_1)]]
    else:
        player_1_5_options = [[{'label': name, 'value': team_unique_ids_1[i]} for i, name in enumerate(team_names_1)]]

    if player_1_6_transfer_tick != None:
        if len(player_1_6_transfer_tick) > 0:
            player_1_6_options = [[{'label': name, 'value': players_2020_unique_ids[i]} for i, name in enumerate(players_2020_names)]]
        else:
            player_1_6_options = [[{'label': name, 'value': team_unique_ids_1[i]} for i, name in enumerate(team_names_1)]]
    else:
        player_1_6_options = [[{'label': name, 'value': team_unique_ids_1[i]} for i, name in enumerate(team_names_1)]]

    if player_1_7_transfer_tick != None:
        if len(player_1_7_transfer_tick) > 0:
            player_1_7_options = [[{'label': name, 'value': players_2020_unique_ids[i]} for i, name in enumerate(players_2020_names)]]
        else:
            player_1_7_options = [[{'label': name, 'value': team_unique_ids_1[i]} for i, name in enumerate(team_names_1)]]
    else:
        player_1_7_options = [[{'label': name, 'value': team_unique_ids_1[i]} for i, name in enumerate(team_names_1)]]

    if player_1_8_transfer_tick != None:
        if len(player_1_8_transfer_tick) > 0:
            player_1_8_options = [[{'label': name, 'value': players_2020_unique_ids[i]} for i, name in enumerate(players_2020_names)]]
        else:
            player_1_8_options = [[{'label': name, 'value': team_unique_ids_1[i]} for i, name in enumerate(team_names_1)]]
    else:
        player_1_8_options = [[{'label': name, 'value': team_unique_ids_1[i]} for i, name in enumerate(team_names_1)]]

    if player_1_9_transfer_tick != None:
        if len(player_1_9_transfer_tick) > 0:
            player_1_9_options = [[{'label': name, 'value': players_2020_unique_ids[i]} for i, name in enumerate(players_2020_names)]]
        else:
            player_1_9_options = [[{'label': name, 'value': team_unique_ids_1[i]} for i, name in enumerate(team_names_1)]]
    else:
        player_1_9_options = [[{'label': name, 'value': team_unique_ids_1[i]} for i, name in enumerate(team_names_1)]]

    if player_1_10_transfer_tick != None:
        if len(player_1_10_transfer_tick) > 0:
            player_1_10_options = [[{'label': name, 'value': players_2020_unique_ids[i]} for i, name in enumerate(players_2020_names)]]
        else:
            player_1_10_options = [[{'label': name, 'value': team_unique_ids_1[i]} for i, name in enumerate(team_names_1)]]
    else:
        player_1_10_options = [[{'label': name, 'value': team_unique_ids_1[i]} for i, name in enumerate(team_names_1)]]

    if player_1_11_transfer_tick != None:
        if len(player_1_11_transfer_tick) > 0:
            player_1_11_options = [[{'label': name, 'value': players_2020_unique_ids[i]} for i, name in enumerate(players_2020_names)]]
        else:
            player_1_11_options = [[{'label': name, 'value': team_unique_ids_1[i]} for i, name in enumerate(team_names_1)]]
    else:
        player_1_11_options = [[{'label': name, 'value': team_unique_ids_1[i]} for i, name in enumerate(team_names_1)]]

    if player_1_s1_transfer_tick != None:
        if len(player_1_s1_transfer_tick) > 0:
            player_1_s1_options = [[{'label': name, 'value': players_2020_unique_ids[i]} for i, name in enumerate(players_2020_names)]]
        else:
            player_1_s1_options = [[{'label': name, 'value': team_unique_ids_1[i]} for i, name in enumerate(team_names_1)]]
    else:
        player_1_s1_options = [[{'label': name, 'value': team_unique_ids_1[i]} for i, name in enumerate(team_names_1)]]

    if player_1_s2_transfer_tick != None:
        if len(player_1_s2_transfer_tick) > 0:
            player_1_s2_options = [[{'label': name, 'value': players_2020_unique_ids[i]} for i, name in enumerate(players_2020_names)]]
        else:
            player_1_s2_options = [[{'label': name, 'value': team_unique_ids_1[i]} for i, name in enumerate(team_names_1)]]
    else:
        player_1_s2_options = [[{'label': name, 'value': team_unique_ids_1[i]} for i, name in enumerate(team_names_1)]]

    if player_1_s3_transfer_tick != None:
        if len(player_1_s3_transfer_tick) > 0:
            player_1_s3_options = [[{'label': name, 'value': players_2020_unique_ids[i]} for i, name in enumerate(players_2020_names)]]
        else:
            player_1_s3_options = [[{'label': name, 'value': team_unique_ids_1[i]} for i, name in enumerate(team_names_1)]]
    else:
        player_1_s3_options = [[{'label': name, 'value': team_unique_ids_1[i]} for i, name in enumerate(team_names_1)]]

    if player_1_s4_transfer_tick != None:
        if len(player_1_s4_transfer_tick) > 0:
            player_1_s4_options = [[{'label': name, 'value': players_2020_unique_ids[i]} for i, name in enumerate(players_2020_names)]]
        else:
            player_1_s4_options = [[{'label': name, 'value': team_unique_ids_1[i]} for i, name in enumerate(team_names_1)]]
    else:
        player_1_s4_options = [[{'label': name, 'value': team_unique_ids_1[i]} for i, name in enumerate(team_names_1)]]
    ...
    if player_2_1_transfer_tick != None:
        if len(player_2_1_transfer_tick) > 0:
            player_2_1_options = [[{'label': name, 'value': players_2020_unique_ids[i]} for i, name in enumerate(players_2020_names)]]
        else:
            player_2_1_options = [[{'label': name, 'value': team_unique_ids_2[i]} for i, name in enumerate(team_names_2)]]

    else:
        player_2_1_options = [[{'label': name, 'value': team_unique_ids_2[i]} for i, name in enumerate(team_names_2)]]

    if player_2_2_transfer_tick != None:
        if len(player_2_2_transfer_tick) > 0:
            player_2_2_options = [[{'label': name, 'value': players_2020_unique_ids[i]} for i, name in enumerate(players_2020_names)]]
        else:
            player_2_2_options = [[{'label': name, 'value': team_unique_ids_2[i]} for i, name in enumerate(team_names_2)]]
    else:
        player_2_2_options = [[{'label': name, 'value': team_unique_ids_2[i]} for i, name in enumerate(team_names_2)]]

    if player_2_3_transfer_tick != None:
        if len(player_2_3_transfer_tick) > 0:
            player_2_3_options = [[{'label': name, 'value': players_2020_unique_ids[i]} for i, name in enumerate(players_2020_names)]]
        else:
            player_2_3_options = [[{'label': name, 'value': team_unique_ids_2[i]} for i, name in enumerate(team_names_2)]]
    else:
        player_2_3_options = [[{'label': name, 'value': team_unique_ids_2[i]} for i, name in enumerate(team_names_2)]]

    if player_2_4_transfer_tick != None:
        if len(player_2_4_transfer_tick) > 0:
            player_2_4_options = [[{'label': name, 'value': players_2020_unique_ids[i]} for i, name in enumerate(players_2020_names)]]
        else:
            player_2_4_options = [[{'label': name, 'value': team_unique_ids_2[i]} for i, name in enumerate(team_names_2)]]
    else:
        player_2_4_options = [[{'label': name, 'value': team_unique_ids_2[i]} for i, name in enumerate(team_names_2)]]

    if player_2_5_transfer_tick != None:
        if len(player_2_5_transfer_tick) > 0:
            player_2_5_options = [[{'label': name, 'value': players_2020_unique_ids[i]} for i, name in enumerate(players_2020_names)]]
        else:
            player_2_5_options = [[{'label': name, 'value': team_unique_ids_2[i]} for i, name in enumerate(team_names_2)]]
    else:
        player_2_5_options = [[{'label': name, 'value': team_unique_ids_2[i]} for i, name in enumerate(team_names_2)]]

    if player_2_6_transfer_tick != None:
        if len(player_2_6_transfer_tick) > 0:
            player_2_6_options = [[{'label': name, 'value': players_2020_unique_ids[i]} for i, name in enumerate(players_2020_names)]]
        else:
            player_2_6_options = [[{'label': name, 'value': team_unique_ids_2[i]} for i, name in enumerate(team_names_2)]]
    else:
        player_2_6_options = [[{'label': name, 'value': team_unique_ids_2[i]} for i, name in enumerate(team_names_2)]]

    if player_2_7_transfer_tick != None:
        if len(player_2_7_transfer_tick) > 0:
            player_2_7_options = [[{'label': name, 'value': players_2020_unique_ids[i]} for i, name in enumerate(players_2020_names)]]
        else:
            player_2_7_options = [[{'label': name, 'value': team_unique_ids_2[i]} for i, name in enumerate(team_names_2)]]
    else:
        player_2_7_options = [[{'label': name, 'value': team_unique_ids_2[i]} for i, name in enumerate(team_names_2)]]

    if player_2_8_transfer_tick != None:
        if len(player_2_8_transfer_tick) > 0:
            player_2_8_options = [[{'label': name, 'value': players_2020_unique_ids[i]} for i, name in enumerate(players_2020_names)]]
        else:
            player_2_8_options = [[{'label': name, 'value': team_unique_ids_2[i]} for i, name in enumerate(team_names_2)]]
    else:
        player_2_8_options = [[{'label': name, 'value': team_unique_ids_2[i]} for i, name in enumerate(team_names_2)]]

    if player_2_9_transfer_tick != None:
        if len(player_2_9_transfer_tick) > 0:
            player_2_9_options = [[{'label': name, 'value': players_2020_unique_ids[i]} for i, name in enumerate(players_2020_names)]]
        else:
            player_2_9_options = [[{'label': name, 'value': team_unique_ids_2[i]} for i, name in enumerate(team_names_2)]]
    else:
        player_2_9_options = [[{'label': name, 'value': team_unique_ids_2[i]} for i, name in enumerate(team_names_2)]]

    if player_2_10_transfer_tick != None:
        if len(player_2_10_transfer_tick) > 0:
            player_2_10_options = [[{'label': name, 'value': players_2020_unique_ids[i]} for i, name in enumerate(players_2020_names)]]
        else:
            player_2_10_options = [[{'label': name, 'value': team_unique_ids_2[i]} for i, name in enumerate(team_names_2)]]
    else:
        player_2_10_options = [[{'label': name, 'value': team_unique_ids_2[i]} for i, name in enumerate(team_names_2)]]

    if player_2_11_transfer_tick != None:
        if len(player_2_11_transfer_tick) > 0:
            player_2_11_options = [[{'label': name, 'value': players_2020_unique_ids[i]} for i, name in enumerate(players_2020_names)]]
        else:
            player_2_11_options = [[{'label': name, 'value': team_unique_ids_2[i]} for i, name in enumerate(team_names_2)]]
    else:
        player_2_11_options = [[{'label': name, 'value': team_unique_ids_2[i]} for i, name in enumerate(team_names_2)]]

    if player_2_s1_transfer_tick != None:
        if len(player_2_s1_transfer_tick) > 0:
            player_2_s1_options = [[{'label': name, 'value': players_2020_unique_ids[i]} for i, name in enumerate(players_2020_names)]]
        else:
            player_2_s1_options = [[{'label': name, 'value': team_unique_ids_2[i]} for i, name in enumerate(team_names_2)]]
    else:
        player_2_s1_options = [[{'label': name, 'value': team_unique_ids_2[i]} for i, name in enumerate(team_names_2)]]

    if player_2_s2_transfer_tick != None:
        if len(player_2_s2_transfer_tick) > 0:
            player_2_s2_options = [[{'label': name, 'value': players_2020_unique_ids[i]} for i, name in enumerate(players_2020_names)]]
        else:
            player_2_s2_options = [[{'label': name, 'value': team_unique_ids_2[i]} for i, name in enumerate(team_names_2)]]
    else:
        player_2_s2_options = [[{'label': name, 'value': team_unique_ids_2[i]} for i, name in enumerate(team_names_2)]]

    if player_2_s3_transfer_tick != None:
        if len(player_2_s3_transfer_tick) > 0:
            player_2_s3_options = [[{'label': name, 'value': players_2020_unique_ids[i]} for i, name in enumerate(players_2020_names)]]
        else:
            player_2_s3_options = [[{'label': name, 'value': team_unique_ids_2[i]} for i, name in enumerate(team_names_2)]]
    else:
        player_2_s3_options = [[{'label': name, 'value': team_unique_ids_2[i]} for i, name in enumerate(team_names_2)]]

    if player_2_s4_transfer_tick != None:
        if len(player_2_s4_transfer_tick) > 0:
            player_2_s4_options = [[{'label': name, 'value': players_2020_unique_ids[i]} for i, name in enumerate(players_2020_names)]]
        else:
            player_2_s4_options = [[{'label': name, 'value': team_unique_ids_2[i]} for i, name in enumerate(team_names_2)]]
    else:
        player_2_s4_options = [[{'label': name, 'value': team_unique_ids_2[i]} for i, name in enumerate(team_names_2)]]
    ...
    if player_3_1_transfer_tick != None:
        if len(player_3_1_transfer_tick) > 0:
            player_3_1_options = [[{'label': name, 'value': players_2020_unique_ids[i]} for i, name in enumerate(players_2020_names)]]
        else:
            player_3_1_options = [[{'label': name, 'value': team_unique_ids_3[i]} for i, name in enumerate(team_names_3)]]

    else:
        player_3_1_options = [[{'label': name, 'value': team_unique_ids_3[i]} for i, name in enumerate(team_names_3)]]

    if player_3_2_transfer_tick != None:
        if len(player_3_2_transfer_tick) > 0:
            player_3_2_options = [[{'label': name, 'value': players_2020_unique_ids[i]} for i, name in enumerate(players_2020_names)]]
        else:
            player_3_2_options = [[{'label': name, 'value': team_unique_ids_3[i]} for i, name in enumerate(team_names_3)]]
    else:
        player_3_2_options = [[{'label': name, 'value': team_unique_ids_3[i]} for i, name in enumerate(team_names_3)]]

    if player_3_3_transfer_tick != None:
        if len(player_3_3_transfer_tick) > 0:
            player_3_3_options = [[{'label': name, 'value': players_2020_unique_ids[i]} for i, name in enumerate(players_2020_names)]]
        else:
            player_3_3_options = [[{'label': name, 'value': team_unique_ids_3[i]} for i, name in enumerate(team_names_3)]]
    else:
        player_3_3_options = [[{'label': name, 'value': team_unique_ids_3[i]} for i, name in enumerate(team_names_3)]]

    if player_3_4_transfer_tick != None:
        if len(player_3_4_transfer_tick) > 0:
            player_3_4_options = [[{'label': name, 'value': players_2020_unique_ids[i]} for i, name in enumerate(players_2020_names)]]
        else:
            player_3_4_options = [[{'label': name, 'value': team_unique_ids_3[i]} for i, name in enumerate(team_names_3)]]
    else:
        player_3_4_options = [[{'label': name, 'value': team_unique_ids_3[i]} for i, name in enumerate(team_names_3)]]

    if player_3_5_transfer_tick != None:
        if len(player_3_5_transfer_tick) > 0:
            player_3_5_options = [[{'label': name, 'value': players_2020_unique_ids[i]} for i, name in enumerate(players_2020_names)]]
        else:
            player_3_5_options = [[{'label': name, 'value': team_unique_ids_3[i]} for i, name in enumerate(team_names_3)]]
    else:
        player_3_5_options = [[{'label': name, 'value': team_unique_ids_3[i]} for i, name in enumerate(team_names_3)]]

    if player_3_6_transfer_tick != None:
        if len(player_3_6_transfer_tick) > 0:
            player_3_6_options = [[{'label': name, 'value': players_2020_unique_ids[i]} for i, name in enumerate(players_2020_names)]]
        else:
            player_3_6_options = [[{'label': name, 'value': team_unique_ids_3[i]} for i, name in enumerate(team_names_3)]]
    else:
        player_3_6_options = [[{'label': name, 'value': team_unique_ids_3[i]} for i, name in enumerate(team_names_3)]]

    if player_3_7_transfer_tick != None:
        if len(player_3_7_transfer_tick) > 0:
            player_3_7_options = [[{'label': name, 'value': players_2020_unique_ids[i]} for i, name in enumerate(players_2020_names)]]
        else:
            player_3_7_options = [[{'label': name, 'value': team_unique_ids_3[i]} for i, name in enumerate(team_names_3)]]
    else:
        player_3_7_options = [[{'label': name, 'value': team_unique_ids_3[i]} for i, name in enumerate(team_names_3)]]

    if player_3_8_transfer_tick != None:
        if len(player_3_8_transfer_tick) > 0:
            player_3_8_options = [[{'label': name, 'value': players_2020_unique_ids[i]} for i, name in enumerate(players_2020_names)]]
        else:
            player_3_8_options = [[{'label': name, 'value': team_unique_ids_3[i]} for i, name in enumerate(team_names_3)]]
    else:
        player_3_8_options = [[{'label': name, 'value': team_unique_ids_3[i]} for i, name in enumerate(team_names_3)]]

    if player_3_9_transfer_tick != None:
        if len(player_3_9_transfer_tick) > 0:
            player_3_9_options = [[{'label': name, 'value': players_2020_unique_ids[i]} for i, name in enumerate(players_2020_names)]]
        else:
            player_3_9_options = [[{'label': name, 'value': team_unique_ids_3[i]} for i, name in enumerate(team_names_3)]]
    else:
        player_3_9_options = [[{'label': name, 'value': team_unique_ids_3[i]} for i, name in enumerate(team_names_3)]]

    if player_3_10_transfer_tick != None:
        if len(player_3_10_transfer_tick) > 0:
            player_3_10_options = [[{'label': name, 'value': players_2020_unique_ids[i]} for i, name in enumerate(players_2020_names)]]
        else:
            player_3_10_options = [[{'label': name, 'value': team_unique_ids_3[i]} for i, name in enumerate(team_names_3)]]
    else:
        player_3_10_options = [[{'label': name, 'value': team_unique_ids_3[i]} for i, name in enumerate(team_names_3)]]

    if player_3_11_transfer_tick != None:
        if len(player_3_11_transfer_tick) > 0:
            player_3_11_options = [[{'label': name, 'value': players_2020_unique_ids[i]} for i, name in enumerate(players_2020_names)]]
        else:
            player_3_11_options = [[{'label': name, 'value': team_unique_ids_3[i]} for i, name in enumerate(team_names_3)]]
    else:
        player_3_11_options = [[{'label': name, 'value': team_unique_ids_3[i]} for i, name in enumerate(team_names_3)]]

    if player_3_s1_transfer_tick != None:
        if len(player_3_s1_transfer_tick) > 0:
            player_3_s1_options = [[{'label': name, 'value': players_2020_unique_ids[i]} for i, name in enumerate(players_2020_names)]]
        else:
            player_3_s1_options = [[{'label': name, 'value': team_unique_ids_3[i]} for i, name in enumerate(team_names_3)]]
    else:
        player_3_s1_options = [[{'label': name, 'value': team_unique_ids_3[i]} for i, name in enumerate(team_names_3)]]

    if player_3_s2_transfer_tick != None:
        if len(player_3_s2_transfer_tick) > 0:
            player_3_s2_options = [[{'label': name, 'value': players_2020_unique_ids[i]} for i, name in enumerate(players_2020_names)]]
        else:
            player_3_s2_options = [[{'label': name, 'value': team_unique_ids_3[i]} for i, name in enumerate(team_names_3)]]
    else:
        player_3_s2_options = [[{'label': name, 'value': team_unique_ids_3[i]} for i, name in enumerate(team_names_3)]]

    if player_3_s3_transfer_tick != None:
        if len(player_3_s3_transfer_tick) > 0:
            player_3_s3_options = [[{'label': name, 'value': players_2020_unique_ids[i]} for i, name in enumerate(players_2020_names)]]
        else:
            player_3_s3_options = [[{'label': name, 'value': team_unique_ids_3[i]} for i, name in enumerate(team_names_3)]]
    else:
        player_3_s3_options = [[{'label': name, 'value': team_unique_ids_3[i]} for i, name in enumerate(team_names_3)]]

    if player_3_s4_transfer_tick != None:
        if len(player_3_s4_transfer_tick) > 0:
            player_3_s4_options = [[{'label': name, 'value': players_2020_unique_ids[i]} for i, name in enumerate(players_2020_names)]]
        else:
            player_3_s4_options = [[{'label': name, 'value': team_unique_ids_3[i]} for i, name in enumerate(team_names_3)]]
    else:
        player_3_s4_options = [[{'label': name, 'value': team_unique_ids_3[i]} for i, name in enumerate(team_names_3)]]


    #GW + 4
    team_names_4 = pd.read_json(team_names_json_4, orient='split', typ='series')
    team_unique_ids_4 = pd.read_json(team_unique_ids_json_4, orient='split', typ='series')

    if player_4_1_transfer_tick != None:
        if len(player_4_1_transfer_tick) > 0:
            player_4_1_options = [[{'label': name, 'value': players_2020_unique_ids[i]} for i, name in enumerate(players_2020_names)]]
        else:
            player_4_1_options = [[{'label': name, 'value': team_unique_ids_4[i]} for i, name in enumerate(team_names_4)]]

    else:
        player_4_1_options = [[{'label': name, 'value': team_unique_ids_4[i]} for i, name in enumerate(team_names_4)]]

    if player_4_2_transfer_tick != None:
        if len(player_4_2_transfer_tick) > 0:
            player_4_2_options = [[{'label': name, 'value': players_2020_unique_ids[i]} for i, name in enumerate(players_2020_names)]]
        else:
            player_4_2_options = [[{'label': name, 'value': team_unique_ids_4[i]} for i, name in enumerate(team_names_4)]]
    else:
        player_4_2_options = [[{'label': name, 'value': team_unique_ids_4[i]} for i, name in enumerate(team_names_4)]]

    if player_4_3_transfer_tick != None:
        if len(player_4_3_transfer_tick) > 0:
            player_4_3_options = [[{'label': name, 'value': players_2020_unique_ids[i]} for i, name in enumerate(players_2020_names)]]
        else:
            player_4_3_options = [[{'label': name, 'value': team_unique_ids_4[i]} for i, name in enumerate(team_names_4)]]
    else:
        player_4_3_options = [[{'label': name, 'value': team_unique_ids_4[i]} for i, name in enumerate(team_names_4)]]

    if player_4_4_transfer_tick != None:
        if len(player_4_4_transfer_tick) > 0:
            player_4_4_options = [[{'label': name, 'value': players_2020_unique_ids[i]} for i, name in enumerate(players_2020_names)]]
        else:
            player_4_4_options = [[{'label': name, 'value': team_unique_ids_4[i]} for i, name in enumerate(team_names_4)]]
    else:
        player_4_4_options = [[{'label': name, 'value': team_unique_ids_4[i]} for i, name in enumerate(team_names_4)]]

    if player_4_5_transfer_tick != None:
        if len(player_4_5_transfer_tick) > 0:
            player_4_5_options = [[{'label': name, 'value': players_2020_unique_ids[i]} for i, name in enumerate(players_2020_names)]]
        else:
            player_4_5_options = [[{'label': name, 'value': team_unique_ids_4[i]} for i, name in enumerate(team_names_4)]]
    else:
        player_4_5_options = [[{'label': name, 'value': team_unique_ids_4[i]} for i, name in enumerate(team_names_4)]]

    if player_4_6_transfer_tick != None:
        if len(player_4_6_transfer_tick) > 0:
            player_4_6_options = [[{'label': name, 'value': players_2020_unique_ids[i]} for i, name in enumerate(players_2020_names)]]
        else:
            player_4_6_options = [[{'label': name, 'value': team_unique_ids_4[i]} for i, name in enumerate(team_names_4)]]
    else:
        player_4_6_options = [[{'label': name, 'value': team_unique_ids_4[i]} for i, name in enumerate(team_names_4)]]

    if player_4_7_transfer_tick != None:
        if len(player_4_7_transfer_tick) > 0:
            player_4_7_options = [[{'label': name, 'value': players_2020_unique_ids[i]} for i, name in enumerate(players_2020_names)]]
        else:
            player_4_7_options = [[{'label': name, 'value': team_unique_ids_4[i]} for i, name in enumerate(team_names_4)]]
    else:
        player_4_7_options = [[{'label': name, 'value': team_unique_ids_4[i]} for i, name in enumerate(team_names_4)]]

    if player_4_8_transfer_tick != None:
        if len(player_4_8_transfer_tick) > 0:
            player_4_8_options = [[{'label': name, 'value': players_2020_unique_ids[i]} for i, name in enumerate(players_2020_names)]]
        else:
            player_4_8_options = [[{'label': name, 'value': team_unique_ids_4[i]} for i, name in enumerate(team_names_4)]]
    else:
        player_4_8_options = [[{'label': name, 'value': team_unique_ids_4[i]} for i, name in enumerate(team_names_4)]]

    if player_4_9_transfer_tick != None:
        if len(player_4_9_transfer_tick) > 0:
            player_4_9_options = [[{'label': name, 'value': players_2020_unique_ids[i]} for i, name in enumerate(players_2020_names)]]
        else:
            player_4_9_options = [[{'label': name, 'value': team_unique_ids_4[i]} for i, name in enumerate(team_names_4)]]
    else:
        player_4_9_options = [[{'label': name, 'value': team_unique_ids_4[i]} for i, name in enumerate(team_names_4)]]

    if player_4_10_transfer_tick != None:
        if len(player_4_10_transfer_tick) > 0:
            player_4_10_options = [[{'label': name, 'value': players_2020_unique_ids[i]} for i, name in enumerate(players_2020_names)]]
        else:
            player_4_10_options = [[{'label': name, 'value': team_unique_ids_4[i]} for i, name in enumerate(team_names_4)]]
    else:
        player_4_10_options = [[{'label': name, 'value': team_unique_ids_4[i]} for i, name in enumerate(team_names_4)]]

    if player_4_11_transfer_tick != None:
        if len(player_4_11_transfer_tick) > 0:
            player_4_11_options = [[{'label': name, 'value': players_2020_unique_ids[i]} for i, name in enumerate(players_2020_names)]]
        else:
            player_4_11_options = [[{'label': name, 'value': team_unique_ids_4[i]} for i, name in enumerate(team_names_4)]]
    else:
        player_4_11_options = [[{'label': name, 'value': team_unique_ids_4[i]} for i, name in enumerate(team_names_4)]]

    if player_4_s1_transfer_tick != None:
        if len(player_4_s1_transfer_tick) > 0:
            player_4_s1_options = [[{'label': name, 'value': players_2020_unique_ids[i]} for i, name in enumerate(players_2020_names)]]
        else:
            player_4_s1_options = [[{'label': name, 'value': team_unique_ids_4[i]} for i, name in enumerate(team_names_4)]]
    else:
        player_4_s1_options = [[{'label': name, 'value': team_unique_ids_4[i]} for i, name in enumerate(team_names_4)]]

    if player_4_s2_transfer_tick != None:
        if len(player_4_s2_transfer_tick) > 0:
            player_4_s2_options = [[{'label': name, 'value': players_2020_unique_ids[i]} for i, name in enumerate(players_2020_names)]]
        else:
            player_4_s2_options = [[{'label': name, 'value': team_unique_ids_4[i]} for i, name in enumerate(team_names_4)]]
    else:
        player_4_s2_options = [[{'label': name, 'value': team_unique_ids_4[i]} for i, name in enumerate(team_names_4)]]

    if player_4_s3_transfer_tick != None:
        if len(player_4_s3_transfer_tick) > 0:
            player_4_s3_options = [[{'label': name, 'value': players_2020_unique_ids[i]} for i, name in enumerate(players_2020_names)]]
        else:
            player_4_s3_options = [[{'label': name, 'value': team_unique_ids_4[i]} for i, name in enumerate(team_names_4)]]
    else:
        player_4_s3_options = [[{'label': name, 'value': team_unique_ids_4[i]} for i, name in enumerate(team_names_4)]]

    if player_4_s4_transfer_tick != None:
        if len(player_4_s4_transfer_tick) > 0:
            player_4_s4_options = [[{'label': name, 'value': players_2020_unique_ids[i]} for i, name in enumerate(players_2020_names)]]
        else:
            player_4_s4_options = [[{'label': name, 'value': team_unique_ids_4[i]} for i, name in enumerate(team_names_4)]]
    else:
        player_4_s4_options = [[{'label': name, 'value': team_unique_ids_4[i]} for i, name in enumerate(team_names_4)]]

    return (player_1_1_options[0],
            player_1_2_options[0],
            player_1_3_options[0],
            player_1_4_options[0],
            player_1_5_options[0],
            player_1_6_options[0],
            player_1_7_options[0],
            player_1_8_options[0],
            player_1_9_options[0],
            player_1_10_options[0],
            player_1_11_options[0],
            player_1_s1_options[0],
            player_1_s2_options[0],
            player_1_s3_options[0],
            player_1_s4_options[0],
            player_2_1_options[0],
            player_2_2_options[0],
            player_2_3_options[0],
            player_2_4_options[0],
            player_2_5_options[0],
            player_2_6_options[0],
            player_2_7_options[0],
            player_2_8_options[0],
            player_2_9_options[0],
            player_2_10_options[0],
            player_2_11_options[0],
            player_2_s1_options[0],
            player_2_s2_options[0],
            player_2_s3_options[0],
            player_2_s4_options[0],
            player_3_1_options[0],
            player_3_2_options[0],
            player_3_3_options[0],
            player_3_4_options[0],
            player_3_5_options[0],
            player_3_6_options[0],
            player_3_7_options[0],
            player_3_8_options[0],
            player_3_9_options[0],
            player_3_10_options[0],
            player_3_11_options[0],
            player_3_s1_options[0],
            player_3_s2_options[0],
            player_3_s3_options[0],
            player_3_s4_options[0],
            player_4_1_options[0],
            player_4_2_options[0],
            player_4_3_options[0],
            player_4_4_options[0],
            player_4_5_options[0],
            player_4_6_options[0],
            player_4_7_options[0],
            player_4_8_options[0],
            player_4_9_options[0],
            player_4_10_options[0],
            player_4_11_options[0],
            player_4_s1_options[0],
            player_4_s2_options[0],
            player_4_s3_options[0],
            player_4_s4_options[0])
